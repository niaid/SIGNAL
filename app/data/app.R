        ...
        mainPanel(
          tabsetPanel(id = "inTabset",
                      tabPanel(title = "Home", value = "landingPage",
                               ...
                               br(),
                               br(),
                               HTML("<center><p>Our manuscript describing the design, development, and testing of SIGNAL can be found <a href='https://www.biorxiv.org/content/10.1101/2020.07.15.204917v2'>here</a>.</p></center>"),
                               HTML("<center><p>To cite: Katz, S., Song, J., Webb, K. P., Lounsbury, N. W., Bryant, C. E., & Fraser, I. D. C. (2020). SIGNAL: A web-based iterative analysis platform integrating pathway and network approaches optimizes hit selection from high-throughput assays. <i>bioRxiv</i>, 2020.2007.2015.204917. doi:10.1101/2020.07.15.204917</p></center>")
