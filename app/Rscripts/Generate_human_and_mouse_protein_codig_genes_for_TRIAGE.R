...
## Run this Rscript in the Rscript folder and it should produce two output files in the Data folder
## $Rscript Generate_human_and_mouse_protein_coding_genes_for_TRIAGE.R
...
write.table(humanGenes, file="../data/HGNC_genes_with_protein_product_EntrezID_geneSymbole_lookup.txt", row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)
...
write.table(mouseGenes, file="../data/Mouse_genes_with_protein_product_EntrezID_geneSymbol_lookup.txt", row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)
